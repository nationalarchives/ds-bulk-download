...
- `Options` (optional) - when using `"Packager": "chunked"` you can set `"Options": [500]` to export batches of 500 files or with `"Packager": "sized"`, using `"Options": [1000000000]` to export batches with files that total 1 GB (before being zipped)
